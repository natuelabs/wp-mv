	...
	<style>
		...
		@media only screen and (min-width: 1538px){
			.header-verao-mundo-verde-banner {
				background-image: url('https://blog.mundoverde.com.br/wp-content/uploads/2020/09/01.09_Banner_MV_1528x565px.png');
			}
		}
		...
		@media only screen and (min-width: 769px) and (max-width: 991px) {
			.header-verao-mundo-verde-banner {
				background-image: url('https://blog.mundoverde.com.br/wp-content/uploads/2020/09/01.09_Cupom_MV_Morumbi-1-1.jpg');
			}
		}
          ...
          <div class="col">
            <div class="linha">
				<div class="col-12 text-center">
					<img src="https://blog.mundoverde.com.br/wp-content/uploads/2020/09/voucher-site.jpg" alt="Voucher">
				</div>      
            </div>
          </div>
        </section>
